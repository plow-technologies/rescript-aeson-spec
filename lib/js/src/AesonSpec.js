...
function sampleGoldenAndServerSpec(decode, encode, name_of_type, url, json_file) {
  var json = JSON.parse(Fs.readFileSync(json_file, "utf8"));
  ...
  if (match.tag) {
    ...
    var sample = match[0];
    describe("AesonSpec.sampleGoldenAndServerSpec: " + (name_of_type + (" from file '" + (json_file + "'"))), (function () {
