...
var Aeson_decode = require("rescript-aeson/lib/js/src/Aeson_decode.js");
var Aeson_encode = require("rescript-aeson/lib/js/src/Aeson_encode.js");
...
function decodeCompany(json) {
  ...
  try {
    v = {
      ...
      employees: Aeson_decode.field("employees", (function (x) {
...
Jest.describe("isJsonFile", (function () {
        Jest.test("", (function () {
                var files = Nodefs.readdirSync("__tests__/golden/Person");
                var filename = files[0];
                return Jest.Expect.toEqual(Jest.Expect.expect(AesonSpec.isJsonFile(filename)), true);
              }));
      }));
