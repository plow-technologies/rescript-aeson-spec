...
AesonSpec.server_roundtrip(decodePerson, encodePerson, "person", "http://localhost:8081/person", person);

AesonSpec.server_roundtrip(decodeCompany, encodeCompany, "company", "http://localhost:8081/company", company);

AesonSpec.server_roundtrip_set(decodePerson, encodePerson, "person", "http://localhost:8081/person", /* :: */[
      person,
      /* :: */[
        person2,
        /* :: */[
...
AesonSpec.golden(decodePerson, encodePerson, "person", "http://localhost:8081/person", "__tests__/sample.json");
