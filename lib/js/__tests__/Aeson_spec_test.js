...
AesonSpec.goldenSpec(decodePerson, encodePerson, "person", "__tests__/person.json");
...
AesonSpec.sampleGoldenAndServerSpec(decodePerson, encodePerson, "person", "http://localhost:8081/people", "__tests__/golden/Person.json");

AesonSpec.sampleGoldenAndServerSpec(decodeCompany, encodeCompany, "person", "http://localhost:8081/companies", "__tests__/golden/Company.json");
