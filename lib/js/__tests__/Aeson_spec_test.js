...
AesonSpec.goldenSingleSpec(decodePerson, encodePerson, "person", "__tests__/person.json");

AesonSpec.serverSingleSpec(decodePerson, encodePerson, "person", "http://localhost:8081/person", person);

AesonSpec.serverSingleSpec(decodeCompany, encodeCompany, "company", "http://localhost:8081/company", company);

AesonSpec.goldenAndServerSpec(decodePerson, encodePerson, "person", "http://localhost:8081/people", "__tests__/golden/Person.json");
