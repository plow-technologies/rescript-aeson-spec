...
var InternalJest = require("../src/InternalJest.js");
...
AesonSpec.goldenDirSpec(decodePerson, brokenEncodePerson, "person", "__tests__/golden/Person");

AesonSpec.goldenDirSpec(decodeShape, encodeShape, "shape", "__tests__/golden/Company");

InternalJest.describe("isJsonFile", (function (param) {
        return InternalJest.test("", (function (param) {
                      var files = Fs.readdirSync("__tests__/golden/Person");
                      var filename = Caml_array.caml_array_get(files, 0);
                      return InternalJest.Expect[/* toEqual */12](true, InternalJest.Expect[/* expect */0](AesonSpec.isJsonFile(filename)));
                    }));
      }));
